...
function DashboardLayout({ children }) {
  ...
  return (
    <div className="h-[100dvh] flex flex-col bg-[var(--bg-dark)] text-white overflow-hidden relative">
      {/* Top Header - Mobile & Desktop */}
      <header className="z-40 flex items-center justify-between px-6 py-6 md:px-10 shrink-0">
      ...
      {/* Main Content Area */}
      <main className="flex-1 flex flex-col min-w-0 pb-24 overflow-y-auto">
        {/* Page Content */}
